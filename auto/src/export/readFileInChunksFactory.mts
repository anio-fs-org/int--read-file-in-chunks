...
export function readFileInChunksFactory(user : UserContext = {}) : ImplementationDocType {
	const project = {
	...
	return async function readFileInChunks(...args: Parameters<ImplementationDocType>) : ReturnType<ImplementationDocType> {
